...
// Výběr správného formátu připojovacího řetězce (měl by začínat "postgresql://" nebo "postgres://")
const databaseUrl = process.env.DATABASE_URL || 
                   process.env.POSTGRES_PRISMA_URL || 
                   process.env.POSTGRES_URL;

if (!databaseUrl) {
  console.error("Chyba: DATABASE_URL není nastavena v .env souboru!");
  process.exit(1);
}

// Inicializace Prisma klienta s explicitním připojovacím řetězcem
