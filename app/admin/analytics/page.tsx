      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400">+20.1% od minulého měsíce</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400">+15.5% od minulého měsíce</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <CardContent>
            <div className="text-2xl font-bold">03:45</div>
            <p className="text-xs text-gray-500 dark:text-gray-400">+5.2% od minulého měsíce</p>
          </CardContent>
        </Card>
      </div>
      <AnalyticsManager />
